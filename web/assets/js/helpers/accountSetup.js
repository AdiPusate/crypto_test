    ...
    popup.on("confirm", () => {
      switch (count) {
        ...
        case 3:
          ...
          popup.setHTML(
            `<span>If you aren't hosting Crypto Website yourself, please be aware that whoever is hosting it can modify the code to steal your data, so make sure you trust them.</span>`
          );
